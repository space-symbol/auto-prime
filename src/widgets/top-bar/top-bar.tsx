  ...
  return (
    <div
      className={classNames(
        'flex items-center justify-between fixed gap-4 top-0 right-0 left-0 border-b-[1px] border-b-gray h-topBar pl-pageLeft pr-pageRight bg-white z-topBar transition-margin py-2 lg:ml-navbar',
        className,
      )}>
